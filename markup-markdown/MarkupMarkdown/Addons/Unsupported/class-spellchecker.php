<?php
/**
 * Unstable addon "SpellChecker" to add spell checking in JavaScript via hungspell
 *
 * @category   Addons
...
/**
 * The class add lang selection on the admin screen and javascript spell checking
 */
class SpellChecker {
	...
	/**
	 * Addon properties. Disabled by default
	 *
	 * @var array
	 */
	private $prop = array(
	...
	/**
	 * Folder containing the dictionnaires
	 *
	 * @var string
	 */
	protected $dict_dir = '';
	...
	/**
	 * Stores a few logs messages in case something went wrong during the dictionaries install
	 *
	 * @var array<string>
	 */
	...
	/**
	 * The languages list for spell checker
	 *
	...
	protected $dictionaries = array(
		...
		'belarusian'          => array(
			'code'      => 'be',
			'label'     => 'Беларуская -- Belarusian (Official)',
			'file_name' => 'be-official',
		),
		'bulgarian'           => array(
			'code'      => 'bg',
		...
		'german_at'           => array(
			'code'      => 'de_AT',
			'label'     => 'Deutsch (AT) -- German (Austria)',
			'file_name' => 'German_de_AT',
		),
		'german_ch'           => array(
			'code'      => 'de_CH',
			'label'     => 'Deutsch (CH) -- German (Switzerland)',
			'file_name' => 'German_de_CH',
		),
		'german_de'           => array(
			'code'      => 'de',
			'label'     => 'Deutsch (DE) -- German',
			'file_name' => 'German_de_DE',
		),
		'greek'               => array(
			'code'      => 'el',
		...
		'english_american'    => array(
			'code'      => 'en_US',
			'label'     => 'English (American)',
			'file_name' => 'English (American)',
		),
		'english_australian'  => array(
			'code'      => 'en_AU',
			'label'     => 'English (Australian)',
			'file_name' => 'English (Australian)',
		),
		'english_british'     => array(
			'code'      => 'en_GB',
			'label'     => 'English (British)',
			'file_name' => 'English (British)',
		),
		'english_canadian'    => array(
			'code'      => 'en_CA',
			'label'     => 'English (Canadian)',
			'file_name' => 'English (Canadian)',
		),
		'english_southafrica' => array(
			'code'      => 'en_ZA',
			'label'     => 'English (South African)',
			'file_name' => 'English (South African)',
		),
		'spanish'             => array(
			'code'      => 'es',
		...
		'hebrew'              => array(
			'code'      => 'he',
			'label'     => 'עברית - ישראל  -- Hebrew (Israel)',
			'file_name' => 'Hebrew (Israel)',
		),
		'croatian'            => array(
			'code'      => 'hr',
		...
		'armenian_east'       => array(
			'code'      => 'hye',
			'label'     => 'հայերեն (արևելյան) -- Armenian (Eastern)',
			'file_name' => 'Armenian (Eastern)',
		),
		'armenian_west'       => array(
			'code'      => 'hyw',
			'label'     => 'հայերեն (արևմտյան) -- Armenian (Western)',
			'file_name' => 'Armenian (Western)',
		),
		'indonesian'          => array(
			'code'      => 'id',
			'label'     => 'Bahasa Indonesia -- Indonesian',
			'file_name' => 'Indonesian',
		),
		'dutch'               => array(
			'code'      => 'nl',
		...
		'latvian'             => array(
			'code'      => 'la',
			'label'     => 'Latvijas -- Latvian',
			'file_name' => 'Latvian',
		),
		'lithuanian'          => array(
			'code'      => 'lt',
			'label'     => 'Lietuvių -- Lithuanian',
			'file_name' => 'Lithuanian',
		),
		'luxembourgish'       => array(
			'code'      => 'lb',
			'label'     => 'Lëtzebuergesch -- Luxembourgish',
			'file_name' => 'Luxembourgish',
		),
		'mongolian'           => array(
			'code'      => 'mn',
		...
		'malaysian'           => array(
			'code'      => 'ms',
			'label'     => 'Malays -- Malaysian',
			'file_name' => 'Malays',
		),
		'norwegian_nb'        => array(
			'code'      => 'nb',
			'label'     => 'Norsk (Bokmål) -- Norwegian',
			'file_name' => 'Norwegian (Bokmal)',
		),
		'norwegian_nn'        => array(
			'code'      => 'nn',
			'label'     => 'Norsk (Nynorsk) -- Norwegian',
			'file_name' => 'Norwegian (Nynorsk)',
		),
		'occitan_fr'          => array(
			'code'      => 'oc',
			'label'     => 'Occitan (France) -- Occitan',
			'file_name' => 'Occitan (France)',
		),
		'persian'             => array(
			'code'      => 'fa',
			'label'     => 'فارسی -- Persian',
		...
		'portuguese_br'       => array(
			...
			'file_name' => 'Portuguese (Brazilian)',
		),
		'portuguese_pt1'      => array(
			'code'      => 'pt_PT',
			'label'     => 'Português (Europeu - Antes do Acordo Ortográfico de 1990) -- Portuguese (European - Before the Ortographic Agreement of 1990)',
			'file_name' => 'Portuguese (European - Before OA 1990)',
		),
		'portuguese_pt2'      => array(
			'code'      => 'pt_PT',
			'label'     => 'Português (Europeu) -- Portuguese (European)',
			'file_name' => 'Portuguese (European)',
		),
		'romanian_ro1'        => array(
			'code'      => 'ro',
			'label'     => 'Română -- Romanian (Ante1993)',
			'file_name' => 'Romanian (Ante1993)',
		),
		'romanian_ro2'        => array(
			'code'      => 'ro',
			'label'     => 'Română -- Romanian (Modern)',
			'file_name' => 'Romanian (Modern)',
		),
		'russian_ru1'         => array(
			'code'      => 'ru',
			'label'     => 'Русский -- Russian (Bilingual English Unified)',
			'file_name' => 'Russian-English Bilingual',
		),
		'russian_ru2'         => array(
			'code'      => 'ru',
			'label'     => 'Русский -- Russian (Modern)',
			'file_name' => 'Russian',
		),
		'russian_ru3'         => array(
			'code'      => 'ru',
			'label'     => 'Русский -- Russian (Pre-reform of 1918)',
			'file_name' => 'ru_petr1708',
		),
		'slovak'              => array(
			'code'      => 'sk_SK',
			'label'     => 'Slovenčina -- Slovak',
			'file_name' => 'Slovak_sk_SK',
		),
		'serbian_latn'        => array(
			'code'      => 'sr_Latn',
			'label'     => 'Srpski (Latinica) -- Serbian (Latin)',
			'file_name' => 'Serbian (Cyrillic)',
		),
		'serbian_cyrl'        => array(
			'code'      => 'sr_Cyrl',
			'label'     => 'Srpski (Ćirilica) -- Serbian (Cyrillic)',
			'file_name' => 'Serbian (Latin)',
		),
		'slovenian'           => array(
			'code'      => 'sl',
		...
		'ukrainian'           => array(
			...
			'file_name' => 'Ukrainian_uk_UA',
		),
		'vietnamese'          => array(
			'code'      => 'vi',
			'label'     => 'Tiếng Việt -- Vietnamese',
			'file_name' => 'Vietnamese_vi_VN',
		),
	);


	/**
	 * Additional words to exclude from the spell checking
	 *
	...
	/**
	 * Quick check if the addon has been activated or not
	 */
	...
	private function initialize() {
		markup_markdown()->default_conf = array(
			'MARKUP_MARKDOWN_SPELL_CHECK' => array(),
		);
	...
	public function update_config( $my_cnf ) {
		$my_cnf['spell_check'] = filter_input( INPUT_POST, 'MARKUP_MARKDOWN_SPELL_CHECK', FILTER_DEFAULT, FILTER_REQUIRE_ARRAY );
	...
	public function create_const( $my_cnf ) {
		$my_cnf['spell_check'] = isset( $my_cnf['spell_check'] ) && is_array( $my_cnf['spell_check'] ) ? $my_cnf['spell_check'] : array();
		if ( isset( $my_cnf['def_lang'] ) && ! empty( $my_cnf['def_lang'] ) ) :
			$pos = array_search( $my_cnf['def_lang'], $my_cnf['spell_check'], true );
			if ( 0 !== (int) $pos ) :
				$my_cnf['spell_check'] = array_merge( array_splice( $my_cnf['spell_check'], $pos, 1 ), $my_cnf['spell_check'] );
			endif;
		endif;
		$my_cnf['MARKUP_MARKDOWN_SPELL_CHECK'] = $my_cnf['spell_check'];
	...
	public function load_spellchecker_assets( $hook ) {
		...
		elseif ( 'settings_page_markup-markdown-admin' === $hook ) :
			add_action( 'markup_markdown_before_options', array( $this, 'install_spell_checker' ) );
	 ...
	 */
	private function check_dict_preferences( $my_dict = array() ) {
		...
		if ( strpos( $locale, '_' ) !== false ) : // Convent "en_US" to [ "en", "US" ].
			$curr_locales = explode( '_', $locale );
		else : // Wrong format so switch default to "en" => [ "en" ].
			$curr_locales = array( $locale );
		endif;
		$my_locales = array();
		...
		foreach ( $curr_locales as $my_locale ) :
			if ( false !== in_array( $my_locale, $my_locales, true ) ) :
				$pos     = array_search( $my_locale, $my_locales, true );
	...
	public function add_inline_editor_conf() {
		$my_dict       = $this->check_dict_preferences( defined( 'MARKUP_MARKDOWN_SPELL_CHECK' ) ? MARKUP_MARKDOWN_SPELL_CHECK : array() );
		$js            = '';
		$n             = 0;
		$dict_base_uri = str_replace( '/plugins/markup-markdown/', '/mmd-dict/', markup_markdown()->plugin_uri );
		foreach ( $my_dict as $dict ) :
			...
			if ( isset( $this->extra[ $dict ] ) && markup_markdown()->exists( $this->dict_dir . '/' . md5( $lang_filename ) . '_extra.dic' ) ) :
	 ...
	 * @access public
	 *
	 * @param string $dict_name Slug of the target dictionnary.
	...
	public function check_for_older_names( $dict_name = '' ) {
		...
		$re       = 0;
		if ( markup_markdown()->exists( $dict_dir . '/' . rawurlencode( $dict_name ) . '.aff' ) ) :
			$mv = markup_markdown()->move( $dict_dir . '/' . rawurlencode( $dict_name ) . '.aff', $dict_dir . '/' . md5( $dict_name ) . '.aff' );
			if ( ! $mv ) :
		...
		if ( markup_markdown()->exists( $dict_dir . '/' . rawurlencode( $dict_name ) . '.dic' ) ) :
			$mv = markup_markdown()->move( $dict_dir . '/' . rawurlencode( $dict_name ) . '.dic', $dict_dir . '/' . md5( $dict_name ) . '.dic' );
			if ( ! $mv ) :
		...
		if ( markup_markdown()->exists( $dict_dir . '/' . rawurlencode( $dict_name ) . '.txt' ) ) :
			$mv = markup_markdown()->move( $dict_dir . '/' . rawurlencode( $dict_name ) . '.txt', $dict_dir . '/' . md5( $dict_name ) . '.txt' );
			if ( ! $mv ) :
				$this->logs[] = 'Unable to rename the dictionary file called ' . $dict_name . '.dic';
			else :
				++$re;
	...
	public function install_spell_checker() {
		...
		if ( ! markup_markdown()->exists( $dict_dir . '/' . md5( $dict_name ) . '.aff' ) || ! markup_markdown()->exists( $dict_dir . '/' . md5( $dict_name ) . '.dic' ) ) :
			// Dictionary already installed, don't do anything.
			$this->install_dictionary( $dict_name, $dict_dir );
		endif;
		if ( isset( $this->extra[ $dict_id ] ) && ! markup_markdown()->exists( $dict_dir . '/' . md5( $dict_name ) . '_extra.dic' ) ) :
	...
	private function install_dictionary( $name = '', $dir = '' ) {
		...
		if ( ! markup_markdown()->exists( $dir ) ) :
			markup_markdown()->mkdir( $dir );
			markup_markdown()->touch( $dir . '/index.php' );
			markup_markdown()->put_contents( $dir . '/index.php', "<?php\n// Silence is Gold\n?>", );
		endif;
		$packages = array(
			'aff' => 'aff. data',
			'dic' => 'dict. data',
		...
		foreach ( $packages as $ext => $desc ) :
			...
			markup_markdown()->put_contents( $dir . '/' . md5( $name ) . '.' . $ext, $resp['body'] );
			unset( $resp ); // Be kind?
	 ...
	 *
	 * @param string $name The dictionary file name.
	 * @param string $parent_name The dictionary group name.
	 * @param string $dir The dictionary directory.
	 * @return boolean TRUE in case of success of FALSE
	 */
	private function install_extra( $name = '', $parent_name = '', $dir = '' ) {
		...
		markup_markdown()->put_contents( $dir . '/' . md5( $parent_name ) . '_extra.dic', $resp['body'] );
		unset( $resp );
		sleep( 1 );
		return true;
	}
	...
	public function add_tabcontent() {
		$my_cnf['spellcheck'] = defined( 'MARKUP_MARKDOWN_SPELL_CHECK' ) ? MARKUP_MARKDOWN_SPELL_CHECK : array();
		?>
					...
					<?php if ( count( $this->logs ) > 0 ) : ?>
						<div id="message" class="notice is-dismissible error">
							...
							<button type="button" class="notice-dismiss"><span class="screen-reader-text"><?php esc_html_e( 'Dismiss this notice', 'markup-markdown' ); ?></span></button>
						</div>
					<?php endif; ?>
						<p>
		...
		foreach ( $this->dictionaries as $dict_id => $dictionary ) :
			...
			if ( markup_markdown()->exists( $curr_base_filename . '.txt' ) ) :
				echo ' (<a href="' . esc_attr( $dict_base_uri . md5( $dictionary['file_name'] ) ) . '.txt" target="_blank">Info</a>)';
			endif;
			echo '</th>';
			if ( markup_markdown()->exists( $curr_base_filename . '.dic' ) && markup_markdown()->exists( $curr_base_filename . '.aff' ) ) :
				echo "\n\t\t\t\t\t\t\t<td>";
				$is_active = isset( $my_cnf['spellcheck'] ) && is_array( $my_cnf['spellcheck'] ) && in_array( $dict_id, $my_cnf['spellcheck'], true ) ? 1 : 0;
				echo "\n\t\t\t\t\t\t\t\t<label for=\"" . esc_attr( 'MARKUP_MARKDOWN_SPELL_CHECK_' . $dict_id ) . '">'
				. "\n\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"MARKUP_MARKDOWN_SPELL_CHECK[]\" id=\"" . esc_attr( 'MARKUP_MARKDOWN_SPELL_CHECK_' . $dict_id ) . '" value="' . esc_attr( $dict_id ) . '"' . ( $is_active ? ' checked="checked"' : ' ' ) . '/>'
				. "\n\t\t\t\t\t\t\t\t\t" . ( $is_active ? esc_html__( 'Active', 'markup-markdown' ) : esc_html__( 'Installed, check to activate', 'markup-markdown' ) );
				echo "\n\t\t\t\t\t\t\t\t</label>";
				echo "\n\t\t\t\t\t\t\t</td>";
				echo "\n\t\t\t\t\t\t\t<td>";
				if ( $is_active ) :
					...
					if ( 0 === (int) array_search( $dict_id, $my_cnf['spellcheck'], true ) ) :
						echo ' checked="checked" /> ' . esc_html__( 'Default', 'markup-markdown' );
					else :
						echo ' /> ' . esc_html__( 'Make default', 'markup-markdown' );
					endif;
					echo "\n\t\t\t\t\t\t\t\t</label>";
					if ( ! markup_markdown()->exists( $curr_base_filename . '_extra.dic' ) && isset( $this->extra[ $dict_id ] ) ) :
